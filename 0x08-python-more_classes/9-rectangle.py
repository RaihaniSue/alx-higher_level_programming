...
class Rectangle:
    """
    Class Rectangle with validated private instance attributes
    width and height

    Attributes:
        number_of_instances: instances of Rectangle
    ...
    def width(self, value):
        """Setter for width, ensures it's a non-negative integer"""
    ...
    def height(self, value):
        """Setter for height, ensures it's a non-negative integer"""
        if type(value) is not int:
